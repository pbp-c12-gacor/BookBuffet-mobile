...
class MyForumPage extends StatefulWidget {
  ...
  @override
  MyForumPageState createState() => MyForumPageState();
}

class MyForumPageState extends State<MyForumPage> {
  ...
  Future<List<Post>> fetchPost(String? category) async {
    ...
    for (var d in data) {
      ...
      if (d != null && (bookCategory == category || category == null)) {
        ...
        if (Post.fromJson(d).fields.user == _user) {
  ...
  Widget build(BuildContext context) {
    ...
    var userId = request.jsonData['id'];
    _user = userId;
    return SafeArea(
      child: Container(
